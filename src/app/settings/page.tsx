            ...
            {!isEditing ? (
              ...
              <div className="flex items-center gap-5 animate-in fade-in duration-300">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-center gap-1.5">
                  ...
                  {/* Name box */}
                  <div className="flex items-center gap-1.5 rounded-md border border-border bg-muted/40 px-2.5 py-1 min-w-0">
                ...
                <div className="flex items-center gap-4 border-b pb-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-muted-foreground">
                      Select an avatar and fill details below
                    </span>
                  </div>
                </div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full overflow-hidden flex items-center justify-center">
                <Image src="/assets/languages.png" alt="Language" width={32} height={32} className="w-full h-full object-cover" unoptimized />
              </div>
              <div className="flex flex-col items-start">
                ...
                <span className="text-xs text-muted-foreground">
                  Active:{" "}
                  {LANGUAGE_LIST.find((l) => l.name === language)?.label ||
                    language}
                </span>
              </div>
            </div>
          ...
          <CardContent className="p-0">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col items-start">
                  <span className="font-semibold text-sm">
                    {t("settings.viewCommunity")}
                  </span>
                  <span className="text-xs text-muted-foreground">
                    {t("settings.communitySub")}
                  </span>
                </div>
              </div>
              <FaChevronRight className="w-3.5 h-3.5 text-muted-foreground" />
